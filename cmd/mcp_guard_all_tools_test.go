...
func TestAllMCPToolsGuarded(t *testing.T) {
	...
	assertMCPToolDenied(t, "senv_backup_get", (*managers).backupGet, backupGetInput{Key: "SECRET"})
	assertMCPToolDenied(t, "senv_backup_set", (*managers).backupSet, envSetValueInput{Key: "SECRET", Value: "plaintext"})
	assertMCPToolDenied(t, "senv_backup_delete", (*managers).backupDelete, envKeyInput{Key: "SECRET"})
	assertMCPToolDenied(t, "senv_backup_list", (*managers).backupList, listInput{Group: "default"})
	...
	assertMCPToolDenied(t, "mcp_server_list", (*managers).mcpServerList, struct{}{})
}
